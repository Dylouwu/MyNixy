{ pkgs, ... }: {
  wayland.windowManager.hyprland.settings = {
    ...
    bindl = [
      ",XF86AudioMute, exec, ${pkgs.swayosd}/bin/swayosd-client --output-volume mute-toggle" # Toggle Mute
    ...
    bindle = [
      ",XF86AudioRaiseVolume, exec, ${pkgs.swayosd}/bin/swayosd-client --output-volume raise" # Sound Up
      ",XF86AudioLowerVolume, exec, ${pkgs.swayosd}/bin/swayosd-client --output-volume lower" # Sound Down
      ",XF86MonBrightnessUp, exec, ${pkgs.swayosd}/bin/swayosd-client --brightness raise" # Brightness Up
      ",XF86MonBrightnessDown, exec, ${pkgs.swayosd}/bin/swayosd-client --brightness lower" # Brightness Down
    ];
