  ...
  config = {
    stylix = {
      ...
      base16Scheme = {
        ...
        base01 = "1c1c24"; # Lighter Background (Used for status bars, line number and folding marks)
        ...
        base0D = "a594fd"; # Functions, Methods, Attribute IDs, Headings, Main purple color
